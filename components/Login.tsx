  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof TypeError && err.message.includes('Failed to fetch')) {
        setError('Não foi possível conectar ao servidor. Verifique se está acessando pelo endereço principal (sem :3000) e se o proxy reverso (Nginx) está configurado.');
      } else {
